...
export interface IOrganizationMemberRepository {
  ...
  findByOrganization(organizationId: string, pagination?: OrganizationMemberPagination): Promise<OrganizationMember[]>;
  ...
  update(id: string, entity: Partial<OrganizationMember>): Promise<OrganizationMember | null>;
